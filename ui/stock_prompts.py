...
- 技術面須同時說明**收盤相對 MA5 與 MA20（月線）**的位置，並依 facts 的**短中線技術面對齊**說明短線與月線是否一致（勿只談 MA5）
...
- 法人/主力是**延續**、**轉折**還是**背離**？
- 融資券餘額變化趨勢、當沖佔比是否異常？
- 股價相對 **MA5 與 MA20（月線）** 的技術位置，以及**短中線是否一致**（短線偏多但月線仍壓？或短中線同步）
（勿重複列數字、勿用表格）
...
若 facts 提供**大盤脈絡**，須說明個股相對大盤是強於/弱於/同步（勿把弱於大盤寫成抗跌）；**不要用表格**。

## 五、短中線情境推演（1～3 個交易日）
**純文字** 2～3 種情境，每種用一小段或條列，**必須**含「觸發條件」（若/一旦/條件/則）與「可觀察訊號」；
